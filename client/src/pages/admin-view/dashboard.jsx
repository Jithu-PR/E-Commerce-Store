...
function AdminDashBoard() {
    ...
    return(
        <div>
            ...
            />
            <Button onClick={handleUploadFeatureImage} disabled={imageLoadingState} className="mt-5 w-full">Upload</Button>
            <div className="flex flex-col gap-4 mt-5">
                {
                    ...
                    ? featureImageList.map((featureImageitem)=> 
                        <div className="relative">
                            ...
                            />
                            <Button onClick={()=> handleImageDelete(featureImageitem._id)} className="mt-2 mb-5">Delete</Button>
                        </div>)
                    : null
                }
            </div>
