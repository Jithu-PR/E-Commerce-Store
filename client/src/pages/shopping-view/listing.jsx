...
function ShoppingListing() {
    ...
    useEffect (()=> {
        console.log('createSearchParamsHelper useeffect',Object.keys(filters).length);
    ...
    return(
        <div className="grid grid-cols-1 md:grid-cols-[200px_1fr] gap-6 p-4 md:p-6">
            ...
            <div className="bg-background w-full rounded-lg shadow-sm">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grip-cols-3 lg:grid-cols-4 gap-4 p-4">
                    {
